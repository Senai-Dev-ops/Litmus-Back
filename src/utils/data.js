...
var sin = 0; // sinal se a máquina está ligada(1) ou desligada(0)
if (sin == 1) {
...
function temporiza(valor, valor2) {
  ...
  inter = setInterval(function () {
    ...
    console.log(
      "\nRotação atual: ",
      Math.floor(80 * valor + (Math.random() * (100 - 1) + 1))
    );
    console.log(
      "\nAvanço: ",
      Math.floor(0.35 * valor + (Math.random() * (0.4375 - 0) + 0))
    );
    console.log(
      "\nTemperatura: ",
    ...
    if (cont > cont2) {
      ...
      if (valor < valor2) {
        ...
        int = setInterval(function () {
          ...
          console.log(
            "\nRotação atual: ",
            Math.floor(80 * pr + (Math.random() * (1000 - 1) + 1))
          );
          console.log(
            "\nAvanço: ",
            Math.floor(0.35 * pr + (Math.random() * (4.375 - 1) + 1))
          );
          console.log(
            "\nTemperatura: ",
            30 + Math.floor(0.5 * pr + (Math.random() * (6.25 - 0) + 0))
          );
          let data = new Date().toLocaleString("pt-BR", {
            timeZone: "America/Sao_Paulo",
          });
        ...
        int = setInterval(function () {
          ...
          console.log(
            "\nRotação atual: ",
            Math.floor(80 * seg + (Math.random() * (1000 - 1) + 1))
          );
          console.log(
            "\nAvanço: ",
            Math.floor(0.35 * seg + (Math.random() * (4.375 - 1) + 1))
          );
          console.log(
            "\nTemperatura: ",
            30 + Math.floor(0.5 * seg + (Math.random() * (6.25 - 0) + 0))
          );
          let data = new Date().toLocaleString("pt-BR", {
            timeZone: "America/Sao_Paulo",
          });
